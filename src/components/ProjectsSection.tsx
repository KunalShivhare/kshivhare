...
function ProjectsSection() {
  ...
  return (
    <div
      id="projects"
      className="h-[full] w-full rounded-md bg-neutral-950 relative flex flex-col items-center antialiased"
    >
      <div className="max-w-full p-4 overflow-x-hidden">
        <div
          id="project-heading"
          className="relative z-10 text-7xl text-white sm:text-[10vw] bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600 text-center mt-20 font-sans font-bold"
        >
          PROJECTS
        </div>
